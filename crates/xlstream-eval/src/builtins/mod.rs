...
pub(crate) fn dispatch(
    ...
    match normalized {
        ...
        "ACOSH" => Some(math::builtin_acosh(&eval_args(args, interp, scope))),
        "ASINH" => Some(math::builtin_asinh(&eval_args(args, interp, scope))),
        "ATANH" => Some(math::builtin_atanh(&eval_args(args, interp, scope))),
        "COSH" => Some(math::builtin_cosh(&eval_args(args, interp, scope))),
        "SINH" => Some(math::builtin_sinh(&eval_args(args, interp, scope))),
        "TANH" => Some(math::builtin_tanh(&eval_args(args, interp, scope))),
        "COT" => Some(math::builtin_cot(&eval_args(args, interp, scope))),
        "CSC" => Some(math::builtin_csc(&eval_args(args, interp, scope))),
        "SEC" => Some(math::builtin_sec(&eval_args(args, interp, scope))),
        "COTH" => Some(math::builtin_coth(&eval_args(args, interp, scope))),
        "CSCH" => Some(math::builtin_csch(&eval_args(args, interp, scope))),
        "SECH" => Some(math::builtin_sech(&eval_args(args, interp, scope))),
        "DEGREES" => Some(math::builtin_degrees(&eval_args(args, interp, scope))),
        "RADIANS" => Some(math::builtin_radians(&eval_args(args, interp, scope))),
